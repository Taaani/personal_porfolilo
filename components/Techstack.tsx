  ...
  return (
    <div className="my-8">
      <div className="mb-8">
        ...
        <ul
          className="ms-4 flex flex-col gap-2"
        ...
        >
          ...
          <li className="text-xl my-2">
            ...
            <span className="bg-primary text-white px-1">dark</span> theme.
          </li>
        </ul>
      </div>
      ...
      <div className="mb-8">
        ...
        >
          <li className="text-xl my-2">
            I use the{" "}
            <span className="bg-primary text-white px-1">PowerShell</span>{" "}
            Terminal.
          </li>
          <li className="text-xl my-2">
            All terminals use{" "}
      ...
      <div className="mb-8">
        ...
        >
          <li className="text-xl my-2">
            ...
            is my main plateforms for virtualization
          </li>
          <li className="text-xl my-2">
            <a
              href="https://www.google.com"
